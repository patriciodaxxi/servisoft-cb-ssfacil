object frmConsPedido_Orc: TfrmConsPedido_Orc
  Left = 213
  Top = 35
  BorderIcons = [biSystemMenu, biMaximize]
  BorderStyle = bsSingle
  Caption = 'Consulta Pedidos/Or'#231'amentos'
  ClientHeight = 611
  ClientWidth = 1017
  Color = clBtnFace
  ...
  object RzPageControl1: TRzPageControl
    ...
    object TS_Item: TRzTabSheet
      Color = 16755027
      Caption = 'Pedidos/Or'#231'amentos'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
      ...
      object SMDBGrid1: TSMDBGrid
        ...
        Align = alClient
        Ctl3D = False
        DataSource = DMPedidoImp.dsPedidoOrcImp
        ...
        Columns = <
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'N'#250'mero de Pedidos'
            Width = 113
            Visible = True
          end
          item

object frmCadRegra_Empresa: TfrmCadRegra_Empresa
  Left = 186
  Top = 12
  Width = 916
  Height = 718
  Caption = 'Cadastro de Regras da Empresa'
  Color = clBtnFace
  ...
  object RzPageControl1: TRzPageControl
    ...
    object TS_Consulta: TRzTabSheet
      ...
      object SMDBGrid1: TSMDBGrid
        ...
        Align = alClient
        Ctl3D = False
        DataSource = DMCadRegra_Empresa.dsConsulta
        ...
        Columns = <
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Tipo Destinat'#225'rio'
            Width = 97
            Visible = True
          end
          item
            ...
            Title.Caption = 'UF Destinat'#225'rio'
            Width = 119
            Visible = True
          end
          item
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Finalidade da Compra'
            Width = 128
            Visible = True
          end>
      end
    ...
    object TS_Cadastro: TRzTabSheet
      ...
      object pnlCadastro: TPanel
        ...
        object DBEdit4: TDBEdit
          ...
          Color = clSilver
          DataField = 'ID'
          DataSource = DMCadRegra_Empresa.dsRegra_Empresa
          ReadOnly = True
          TabOrder = 0
        end
        object RxDBLookupCombo4: TRxDBLookupCombo
          ...
          LookupField = 'ID'
          LookupDisplay = 'NOME'
          LookupSource = DMCadRegra_Empresa.dsOperacao_Nota
          TabOrder = 1
        end
        ...
        object RxDBLookupCombo1: TRxDBLookupCombo
          ...
          LookupSource = DMCadRegra_Empresa.dsCFOP
          TabOrder = 6
        end
        object DBRadioGroup4: TDBRadioGroup
          ...
          Width = 209
          Height = 57
          Caption = ' Finalidade da Compra'
          Columns = 2
          DataField = 'FINALIDADE_COMPRADOR'
          DataSource = DMCadRegra_Empresa.dsRegra_Empresa
          Items.Strings = (
            'Revenda'
      ...
      object SMDBGrid2: TSMDBGrid
        ...
        Align = alClient
        Ctl3D = False
        DataSource = DMCadRegra_Empresa.dsRegra_Empresa_Itens
        Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit]
        ParentCtl3D = False
        ReadOnly = True
        TabOrder = 2
        ...
        Columns = <
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Destinat'#225'rio (Jur'#237'dica/F'#237'sica)'
            Title.Color = 16777162
            Width = 107
            Visible = True
          end
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Tipo Produto (Venda/Revenda/M'#227'o de Obra)'
            Title.Color = 16777162
            Width = 126
            Visible = True
          end

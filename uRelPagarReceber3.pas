...
type
  TfRelPagarReceber3 = class(TForm)
    RLReport1: TRLReport;
    RLBand1: TRLBand;
...
var
  fRelPagarReceber3: TfRelPagarReceber3;
...
procedure TfRelPagarReceber3.RLReport1BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TfRelPagarReceber3.RLBand4BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TfRelPagarReceber3.RLBand3BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TfRelPagarReceber3.RLBand6BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  if fDMCadDuplicata.cdsDuplicata_ConsultaTIPO_ES.AsString = 'E' then
...
procedure TfRelPagarReceber3.RLBand1BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  if vTipo_ES = 'E' then
...
procedure TfRelPagarReceber3.FormClose(Sender: TObject;
...
procedure TfRelPagarReceber3.FormCreate(Sender: TObject);
begin
...
procedure TfRelPagarReceber3.RLBand5BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  PrintIt := (not vLista);
  if not PrintIt then
...
procedure TfRelPagarReceber3.RLBand7BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
var
  vAux: Real;
begin
...
procedure TfRelPagarReceber3.RLBand8BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
var
  vAux: Real;
begin
...
procedure TfRelPagarReceber3.RLBand9BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
var
  vAux: Real;
begin
...
procedure TfRelPagarReceber3.FormDestroy(Sender: TObject);
begin
  FreeAndNil(fDMRel);
end;

procedure TfRelPagarReceber3.RLBand10BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TfRelPagarReceber3.RLBand2BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  PrintIt := (vTipo_Lista <> 'S');
end;

procedure TfRelPagarReceber3.RLBand11BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  PrintIt := (not vLista) ;
  if not PrintIt then
...
procedure TfRelPagarReceber3.RLBand12BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin

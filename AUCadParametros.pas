...
begin
  ...
  DBCheckBox137.Visible := ((fDMCadParametros.cdsParametrosINFORMAR_COR_PROD.AsString = 'B') and (fDMCadParametros.cdsParametros_LoteLOTE_TEXTIL.AsString = 'S'));

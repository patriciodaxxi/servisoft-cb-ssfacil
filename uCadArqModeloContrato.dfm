object frmCadArqModeloContrato: TfrmCadArqModeloContrato
  Left = 416
  Top = 281
  Width = 575
  Height = 187
  BorderIcons = [biSystemMenu, biMaximize]
  Caption = 'frmCadArqModeloContrato'
  Color = clBtnFace
  ...
  object FilenameEdit1: TFilenameEdit
    ...
    Width = 369
    Height = 21
    Filter = 'Modelos|*.doc|Modelos|*.docx|All files (*.*)|*.*'
    NumGlyphs = 1
    TabOrder = 1
  end
  object DBLookupComboBox1: TDBLookupComboBox
    ...
    KeyField = 'ID'
    ListField = 'NOME'
    ListSource = DMCadServico_Int.dsFilial
    TabOrder = 0
  end
end

object frmConsEstoque_Mov_Vei: TfrmConsEstoque_Mov_Vei
  Left = 170
  Top = 111
  ...
  object Panel1: TPanel
    ...
    object RxDBLookupCombo2: TRxDBLookupCombo
      ...
      LookupField = 'ID'
      LookupDisplay = 'PLACA'
      LookupSource = DMConsEstoque.dsVeiculo
      TabOrder = 1
  ...
  object SMDBGrid1: TSMDBGrid
    ...
    Align = alClient
    Ctl3D = False
    DataSource = DMConsEstoque.dsEstoque_Mov_Vei
    ...
    Columns = <
      ...
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Dados do Ve'#237'culo'
        Width = 368
        Visible = True
      end
      item

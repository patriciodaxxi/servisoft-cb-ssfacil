object frmCadCheque: TfrmCadCheque
  ...
  object RzPageControl1: TRzPageControl
    ...
    object TS_Consulta: TRzTabSheet
      ...
      object SMDBGrid1: TSMDBGrid
        ...
        Columns = <
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Motivo Compensado'
            Width = 344
            Visible = True
          end
          item
      ...
      object Panel2: TPanel
        ...
        object btnCompensar: TNxButton
          Left = 460
          Top = 2
          Width = 153
          Height = 30
          Hint = 'Compensar cheques selecionados'
          Caption = 'Compensar'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -16
      ...
      object pnlPesquisa: TPanel
        ...
        object RxDBLookupCombo1: TRxDBLookupCombo
          ...
          LookupField = 'ID'
          LookupDisplay = 'NOME'
          LookupSource = dmCadCheque.dsContas
          TabOrder = 2
        ...
        object RxDBLookupCombo7: TRxDBLookupCombo
          ...
          LookupField = 'ID'
          LookupDisplay = 'NOME'
          LookupSource = dmCadCheque.dsBanco
          TabOrder = 3
          OnEnter = RxDBLookupCombo1Enter
        end
      end
      ...
      object pnlCadastro: TPanel
        ...
        object pnlNota: TPanel
          ...
          object DBEdit8: TDBEdit
            ...
            Color = clSilver
            DataField = 'ID'
            DataSource = dmCadCheque.dsCheque
            ReadOnly = True
            TabOrder = 0
          end
        end
        object RzPageControl2: TRzPageControl
          ...
          object TS_Mim: TRzTabSheet
            ...
            object RxDBLookupCombo5: TRxDBLookupCombo
              ...
              Height = 21
              DropDownCount = 8
              DataField = 'EMITIDO_PARA'
              DataSource = dmCadCheque.dsCheque
              LookupField = 'CODIGO'
              LookupDisplay = 'NOME'
              LookupSource = dmCadCheque.dsPessoaReceptor
              TabOrder = 1
            ...
            object RxDBLookupCombo6: TRxDBLookupCombo
              ...
              LookupSource = dmCadCheque.dsContaOrcamento
              TabOrder = 4
              OnEnter = RxDBLookupCombo5Enter
              OnExit = RxDBLookupCombo5Exit
            end
          ...
          object TS_Cliente: TRzTabSheet
            ...
            object RxDBLookupCombo4: TRxDBLookupCombo
              ...
              LookupField = 'CODIGO'
              LookupDisplay = 'NOME'
              LookupSource = dmCadCheque.dsPessoaEmissor
              TabOrder = 0
      ...
      object RzPageControl3: TRzPageControl
        ...
        object RzTabSheet1: TRzTabSheet
          ...
          object SMDBGrid2: TSMDBGrid
            ...
            Align = alClient
            Ctl3D = False
            DataSource = dmCadCheque.dsCheque_Hist
        ...
        object RzTabSheet2: TRzTabSheet
          ...
          object SMDBGrid3: TSMDBGrid
            ...
            Align = alClient
            Ctl3D = False
            DataSource = dmCadCheque.dsCheque_Tit
            Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit]
            ParentCtl3D = False
            ReadOnly = True
            TabOrder = 0
  ...
  object PopupMenu1: TPopupMenu
    Left = 417
    Top = 7
    object Copiadecheque1: TMenuItem
      Caption = 'Copia de cheque'
      OnClick = Copiadecheque1Click
    end

object frmConsLoteMat: TfrmConsLoteMat
  Left = 204
  Top = 40
  Width = 1051
  Height = 630
  Caption = 'Consulta Lote Materiais'
  Color = clBtnFace
  ...
  object pnlCadastro: TPanel
    ...
    object RxDBLookupCombo1: TRxDBLookupCombo
      ...
      LookupField = 'ID'
      LookupDisplay = 'NOME'
      LookupSource = DMCadNecessidade_Compras.dsSetor
      ParentCtl3D = False
      TabOrder = 4
    end
  end

object frmCadFilial_Email: TfrmCadFilial_Email
  Left = 392
  Top = 200
  ...
  object RxDBLookupCombo1: TRxDBLookupCombo
    ...
    Height = 21
    DropDownCount = 8
    DataField = 'ID_CONFIG_EMAIL'
    DataSource = DMCadFilial.dsFilial_Email
    LookupField = 'ID'
    LookupDisplay = 'NOME_CONFIG'
    LookupSource = DMCadFilial.dsConfig_Email
    TabOrder = 2
  end
end

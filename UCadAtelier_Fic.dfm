object frmCadAtelier_Fic: TfrmCadAtelier_Fic
  Left = 313
  Top = 188
  Width = 763
  Height = 462
  BorderIcons = [biSystemMenu, biMaximize]
  Caption = 'Cadastro da Ficha do Atelier'
  Color = clBtnFace
  ...
  object RzPageControl1: TRzPageControl
    ...
    object TS_Consulta: TRzTabSheet
      ...
      object SMDBGrid1: TSMDBGrid
        ...
        Align = alClient
        Ctl3D = False
        DataSource = DMCadAtelier_Fic.dsAtelier_Fic
    ...
    object TS_Cadastro: TRzTabSheet
      ...
      object pnlCadastro: TPanel
        ...
        object RxDBLookupCombo1: TRxDBLookupCombo
          ...
          LookupField = 'CODIGO'
          LookupDisplay = 'NOME'
          LookupSource = DMCadAtelier_Fic.dsPessoa
          TabOrder = 1
        end
        object DBCheckBox1: TDBCheckBox
          ...
          Height = 17
          Caption = 
            'A Definir (na baixa do tal'#227'o vai ser preciso informar um Atelier' +
            ')'
          DataField = 'ADEFINIR'
          DataSource = DMCadAtelier_Fic.dsAtelier_Fic
          TabOrder = 2

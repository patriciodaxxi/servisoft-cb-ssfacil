object frmCadServico_Int: TfrmCadServico_Int
  Left = 217
  Top = 84
  Width = 845
  Height = 613
  Caption = 'Cadastro do Servi'#231'o Interno'
  Color = clBtnFace
  ...
  object RzPageControl1: TRzPageControl
    ...
    object TS_Consulta: TRzTabSheet
      ...
      object SMDBGrid1: TSMDBGrid
        ...
        Align = alClient
        Ctl3D = False
        DataSource = DMCadServico_Int.dsServico_Int
    ...
    object TS_Cadastro: TRzTabSheet
      ...
      object pnlCadastro: TPanel
        ...
        object Label7: TLabel
          ...
          Height = 13
          Alignment = taRightJustify
          Caption = 'C'#243'digo Servi'#231'o Padr'#227'o:'
          Transparent = False
        end
        ...
        object RxDBLookupCombo1: TRxDBLookupCombo
          ...
          LookupField = 'CODIGO'
          LookupDisplay = 'NOME'
          LookupSource = DMCadServico_Int.dsVendedor
          TabOrder = 3
        end
        ...
        object RxDBLookupCombo2: TRxDBLookupCombo
          ...
          DropDownCount = 8
          DropDownWidth = 600
          DataField = 'CODIGO_NBS'
          DataSource = DMCadServico_Int.dsServico_Int
          LookupField = 'CODIGO'
          LookupDisplay = 'CODIGO;NOME'
          LookupSource = DMCadServico_Int.dsTab_IBPT
          TabOrder = 5
        end
        object RxDBLookupCombo3: TRxDBLookupCombo
          ...
          DropDownCount = 8
          DropDownWidth = 600
          DataField = 'ID_SERVICO_PADRAO'
          DataSource = DMCadServico_Int.dsServico_Int
          LookupField = 'ID'
          LookupDisplay = 'NOME_SERVICO'
          LookupSource = DMCadServico_Int.dsServico
          TabOrder = 6
        end
        ...
        object Panel3: TPanel
          ...
          object Label9: TLabel
            ...
            Height = 13
            Caption = 
              'Arquivos de modelo de contrato para o servi'#231'o por filial (Arquiv' +
              'o do Word)'
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWhite
            Font.Height = -11
        ...
        object SMDBGrid2: TSMDBGrid
          ...
          Height = 171
          Align = alBottom
          DataSource = DMCadServico_Int.dsServico_Int_Mod_Contrato
          Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit]
          TabOrder = 9
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText

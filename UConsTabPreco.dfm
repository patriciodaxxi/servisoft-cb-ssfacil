object frmConsTabPreco: TfrmConsTabPreco
  Left = 108
  Top = 135
  Width = 922
  Height = 556
  Caption = 'Consulta Tabela Pre'#231'o'
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object RxDBLookupCombo2: TRxDBLookupCombo
      ...
      LookupField = 'ID'
      LookupDisplay = 'NOME'
      LookupSource = DMCadTab_Preco.dsGrupo
      TabOrder = 4
    end
    object RxDBLookupCombo4: TRxDBLookupCombo
      ...
      LookupField = 'ID'
      LookupDisplay = 'NOME'
      LookupSource = DMCadTab_Preco.dsMarca
      TabOrder = 5
    end

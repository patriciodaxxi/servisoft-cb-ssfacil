object frmConsEstoque_Bal_Vei: TfrmConsEstoque_Bal_Vei
  Left = 227
  Top = 104
  BorderStyle = bsSingle
  Caption = 'Consulta Balan'#231'o Estoque Ve'#237'culo'
  ClientHeight = 518
  ClientWidth = 926
  Color = clBtnFace
  ...
  object SMDBGrid1: TSMDBGrid
    ...
    Align = alClient
    Ctl3D = False
    DataSource = DMConsEstoque.dsBalanco_Vei
    ...
    Columns = <
      ...
      item
        ...
        Title.Caption = 'Dados do Ve'#237'culo/Moto'
        Width = 358
        Visible = True
      end
      item

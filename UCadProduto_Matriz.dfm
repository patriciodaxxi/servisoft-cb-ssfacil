object frmCadProduto_Matriz: TfrmCadProduto_Matriz
  Left = 350
  Top = 266
  ...
  object Panel2: TPanel
    ...
    object RxDBLookupCombo2: TRxDBLookupCombo
      ...
      Height = 21
      DropDownCount = 8
      DataField = 'ID_MATRIZ_PRECO'
      DataSource = DMCadProduto.dsProduto_Matriz
      LookupField = 'ID'
      LookupDisplay = 'NOME'
      LookupSource = DMCadProduto.dsMatriz_Preco
      TabOrder = 0
    end

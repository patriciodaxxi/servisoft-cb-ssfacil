object frmConsNotas: TfrmConsNotas
  ...
  object Panel1: TPanel
    ...
    object RxDBLookupCombo2: TRxDBLookupCombo
      ...
      LookupField = 'CODIGO'
      LookupDisplay = 'NOME'
      LookupSource = DMConsNotas.dsCliente
      ParentCtl3D = False
      TabOrder = 3
    ...
    object RxDBLookupCombo3: TRxDBLookupCombo
      ...
      LookupField = 'ID'
      LookupDisplay = 'NOME'
      LookupSource = DMConsNotas.dsProduto
      ParentCtl3D = False
      TabOrder = 5
  ...
  object RzPageControl1: TRzPageControl
    ...
    object TS_DTEmissao: TRzTabSheet
      ...
      object SMDBGrid4: TSMDBGrid
        ...
        Align = alClient
        Ctl3D = False
        DataSource = DMConsNotas.dsNotaFiscal_DT
    ...
    object TS_Produto_Det: TRzTabSheet
      ...
      object SMDBGrid19: TSMDBGrid
        ...
        Align = alClient
        Ctl3D = False
        DataSource = DMConsNotas.dsProduto_Det
        Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit]
        ParentCtl3D = False
        ReadOnly = True
        TabOrder = 0
    ...
    object TS_Nota: TRzTabSheet
      ...
      object SMDBGrid6: TSMDBGrid
        ...
        Align = alClient
        Ctl3D = False
        DataSource = DMConsNotas.dsNotaFiscal
        Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit]
        ParentCtl3D = False
        ReadOnly = True
        TabOrder = 0
    ...
    object TS_ReciboNF: TRzTabSheet
      ...
      object SMDBGrid17: TSMDBGrid
        ...
        Align = alClient
        Ctl3D = False
        DataSource = DMConsNotas.dsReciboNF
        Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit]
        ParentCtl3D = False
        ReadOnly = True
        TabOrder = 0
  ...
  object Panel3: TPanel
    ...
    object Label1: TLabel
      ...
      Height = 13
      Alignment = taRightJustify
      Caption = 'Total Industrializa'#231#227'o:'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'MS Sans Serif'

object frmGerar_NFSe_Consumo: TfrmGerar_NFSe_Consumo
  Left = 246
  Top = 90
  Width = 922
  Height = 459
  BorderIcons = [biSystemMenu, biMaximize]
  Caption = 'frmGerar_NFSe_Consumo'
  Color = clBtnFace
  ...
  object SMDBGrid2: TSMDBGrid
    ...
    Align = alClient
    Ctl3D = False
    DataSource = DMCadOS.dsmContrato_Consumo
    ...
    Columns = <
      ...
      item
        ...
        ReadOnly = True
        Title.Alignment = taCenter
        Title.Caption = 'Vlr. C'#243'pia Excedente'
        Title.Color = 16777173
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -12
      ...
      item
        ...
        FieldName = 'QTD_ANT'
        Title.Alignment = taCenter
        Title.Caption = 'Contador Anterior'
        Title.Color = 16777173
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -12
      ...
      item
        ...
        ReadOnly = True
        Title.Alignment = taCenter
        Title.Caption = 'Vlr. Total Excedente'
        Title.Color = 16777173
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -12

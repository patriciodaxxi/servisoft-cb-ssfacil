object frmBaixaNFDevolvida: TfrmBaixaNFDevolvida
  Left = 131
  Top = 55
  BorderIcons = [biSystemMenu, biMaximize]
  BorderStyle = bsSingle
  Caption = 'Baixa NF Beneficiamento'
  ClientHeight = 564
  ClientWidth = 1133
  Color = clBtnFace
  ...
  object SMDBGrid1: TSMDBGrid
    ...
    Align = alClient
    Ctl3D = False
    DataSource = DMConsNotaBeneficiamento.dsNotaPendente

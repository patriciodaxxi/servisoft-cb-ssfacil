object frmCadDuplicata_Cob: TfrmCadDuplicata_Cob
  Left = 386
  Top = 147
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'frmCadDuplicata_Cob'
  ClientHeight = 337
  ClientWidth = 912
  Color = clBtnFace
  ...
  object SMDBGrid1: TSMDBGrid
    ...
    Height = 204
    Align = alBottom
    DataSource = DMCadDuplicata.dsDuplicata_Cob
    ...
    Columns = <
      ...
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'ID Ocorr'#234'ncia'
        Width = 106
        Visible = True
      end
      item

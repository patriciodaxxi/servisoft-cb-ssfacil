object frmConsCtaOrcamento_Fin_Dt: TfrmConsCtaOrcamento_Fin_Dt
  Left = 240
  Top = 133
  Width = 1010
  Height = 522
  Caption = 'frmConsCtaOrcamento_Fin_Dt'
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object CheckBox1: TCheckBox
      ...
      Width = 190
      Height = 17
      Caption = 'Imprimir os valores sem contas'
      Checked = True
      State = cbChecked
      TabOrder = 4
      Visible = False
  ...
  object DBGrid1: TDBGrid
    ...
    Columns = <
      ...
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Semana 1'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'Desc_Valor1.Vlr_Previsto1'
        Title.Alignment = taCenter
      ...
      item
        Expanded = False
        FieldName = 'Desc_Valor1.Vlr_Realizado1'
        Title.Alignment = taCenter
      ...
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Semana 2'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'Desc_Valor2.Vlr_Previsto2'
        Title.Alignment = taCenter
        Title.Caption = 'Vlr. Previsto'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'Desc_Valor2.Vlr_Realizado2'
        Title.Alignment = taCenter
        Title.Caption = 'Vlr. Realizado'
        Visible = True
      end
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Semana 3'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'Desc_Valor3.Vlr_Previsto3'
        Title.Alignment = taCenter
        Title.Caption = 'Vlr. Previsto'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'Desc_Valor3.Vlr_Realizado3'
        Title.Alignment = taCenter
        Title.Caption = 'Vlr. Realizado'
        Visible = True
      end
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Semana 4'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'Desc_Valor4.Vlr_Previsto4'
        Title.Alignment = taCenter
        Title.Caption = 'Vlr. Previsto'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'Desc_Valor4.Vlr_Realizado4'
        Title.Alignment = taCenter
        Title.Caption = 'Vlr. Realizado'
        Visible = True
      end
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Semana 5'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'Desc_Valor5.Vlr_Previsto5'
        Title.Alignment = taCenter
        Title.Caption = 'Vlr. Previsto'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'Desc_Valor5.Vlr_Realizado5'
        Title.Alignment = taCenter
        Title.Caption = 'Vlr. Realizado'
        Visible = True
      end>

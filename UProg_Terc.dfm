object frmProg_Terc: TfrmProg_Terc
  Left = 180
  Top = 77
  BorderIcons = [biSystemMenu, biMaximize]
  BorderStyle = bsSingle
  Caption = 'Program'#231#227'o de Terceiro (Ordem de libera'#231#227'o para o faturamento)'
  ClientHeight = 564
  ClientWidth = 995
  Color = clBtnFace
  ...
  object RzPageControl1: TRzPageControl
    ...
    object TS_Liberados: TRzTabSheet
      ...
      object RzPageControl2: TRzPageControl
        ...
        object TS_Produto_Lib: TRzTabSheet
          Color = 16777088
          Caption = 'Produtos Liberados'
      ...
      object Panel1: TPanel
        ...
        object RxDBLookupCombo3: TRxDBLookupCombo
          ...
          LookupField = 'ID'
          LookupDisplay = 'NOME'
          LookupSource = DMProg_Terc.dsFilial
          ParentCtl3D = False
          TabOrder = 0
        end
    ...
    object TS_Produto_Pend: TRzTabSheet
      Color = 8453888
      Caption = 'Produtos N'#227'o Liberados'
      object Panel4: TPanel
        ...
        object btnConsultar_Pend: TNxButton
          Left = 629
          Top = 15
          Width = 114
          Caption = 'Efetuar Pesquisa'
          TabOrder = 2
          OnClick = btnConsultar_PendClick
        end
        object btnImprimir_NaoLib: TNxButton
          Left = 742
          Top = 15
          Width = 114
          Caption = 'Imprimir'
          TabOrder = 3
          OnClick = btnImprimir_NaoLibClick
        end
      end
      object NxPanel1: TNxPanel
        ...
        object NxButton3: TNxButton
          ...
          Width = 211
          Height = 27
          Caption = 'Confirmar Libera'#231#227'o'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlue
          Font.Height = -13
          Font.Name = 'Verdana'

...
procedure NFeDistNSU(AServidor, ACnpj, AChaveAcesso, ACNPJConsulta, AUF, AultNSURecebido: String; var AultNSU, AmaxNSU: String; var AqtdeDocto: Integer; AXml: TStream);
...
type
  ...
  public
    constructor CreateNFSe(const Msg: string);
  ...
  try
    try
      ...
      begin
        ...
        raise EExceptionNFSe.CreateNFSe(TCPClient.ReadLn);
    finally
      TCPClient.Disconnect;
    end;
  finally
...
constructor EExceptionNFSe.CreateNFSe(const Msg: string);
var
  List: TStringList;
  I: Integer;

object frmCadProduto_Atelier: TfrmCadProduto_Atelier
  Left = 343
  Top = 98
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Cadastro de Atelier'
  ClientHeight = 514
  ClientWidth = 656
  Color = clBtnFace
  ...
  object SMDBGrid1: TSMDBGrid
    ...
    Align = alClient
    Ctl3D = False
    DataSource = dmCadProduto.dsProduto_Atelier
  ...
  object pnlDados: TPanel
    ...
    object RxDBLookupCombo1: TRxDBLookupCombo
      ...
      LookupField = 'CODIGO'
      LookupDisplay = 'NOME'
      LookupSource = dmCadProduto.dsAtelier
      ParentCtl3D = False
      TabOrder = 1
    end

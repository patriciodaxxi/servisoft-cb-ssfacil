object frmSel_Pedido_Tam: TfrmSel_Pedido_Tam
  Left = 138
  Top = 109
  Width = 1116
  Height = 568
  BorderIcons = [biSystemMenu]
  Caption = 'Selecionar os Pedidos Com Grade'
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Label6: TLabel
      ...
      Width = 260
      Height = 13
      Caption = 'Produto n'#227'o copiado, qtde no estoque n'#227'o '#233' suficiente'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clMaroon
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
  ...
  object SMDBGrid1: TSMDBGrid
    ...
    Align = alClient
    Ctl3D = False
    DataSource = DMCadNotaFiscal.dsPedido_Tam

object frmCadTransferencia: TfrmCadTransferencia
  ...
  Caption = 'Transfer'#234'ncia entre contas (financeiro)'
  Color = clBtnFace
  ...
  object RzPageControl1: TRzPageControl
    ...
    object TS_Consulta: TRzTabSheet
      ...
      object SMDBGrid1: TSMDBGrid
        ...
        Align = alClient
        Ctl3D = False
        DataSource = DMCadTransferencia.dsTransferencia_Consulta
        ...
        Columns = <
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Op. Contabil Origem'
            Width = 189
            Visible = True
          end
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Op. Contabil Destino'
            Width = 169
            Visible = True
          end>
      end
      ...
      object pnlPesquisa: TPanel
        ...
        object Label3: TLabel
          ...
          Caption = 'Data Movimento Inicial:'
        end
    ...
    object TS_Cadastro: TRzTabSheet
      ...
      object pnlCadastro: TPanel
        ...
        object Label7: TLabel
          ...
          Width = 122
          Height = 13
          Caption = 'Conta Or'#231'amento Origem:'
        end
        object Label9: TLabel
          ...
          Width = 125
          Height = 13
          Caption = 'Conta Or'#231'amento Destino:'
        end
        object Label10: TLabel
          ...
          Height = 13
          Alignment = taRightJustify
          Caption = 'Forma de Transfer'#234'ncia:'
        end
        ...
        object DBEdit4: TDBEdit
          ...
          Color = clSilver
          DataField = 'ID'
          DataSource = DMCadTransferencia.dsTransferencia
          ReadOnly = True
          TabOrder = 8
        end
        ...
        object RxDBLookupCombo1: TRxDBLookupCombo
          ...
          Height = 21
          DropDownCount = 8
          DataField = 'ID_CONTA_ORI'
          DataSource = DMCadTransferencia.dsTransferencia
          LookupField = 'ID'
          LookupDisplay = 'NOME'
          LookupSource = DMCadTransferencia.dsContas
          TabOrder = 1
        end
        ...
        object DBEdit3: TDBEdit
          ...
          Width = 97
          Height = 21
          DataField = 'ID_CONTA_ORC_DESTINO'
          DataSource = DMCadTransferencia.dsTransferencia
          TabOrder = 7
        ...
        object edtNome_OrcOrigem: TEdit
          Left = 650
          Top = 29
          Width = 201
          Height = 21
        ...
        object edtNome_OrcDestino: TEdit
          Left = 650
          Top = 50
          Width = 201
          Height = 21
        ...
        object RxDBLookupCombo3: TRxDBLookupCombo
          ...
          LookupField = 'ID'
          LookupDisplay = 'NOME'
          LookupSource = DMCadTransferencia.dsTipoCobranca
          TabOrder = 3
        end
        ...
        object gbxContabil: TRzGroupBox
          ...
          object RxDBLookupCombo11: TRxDBLookupCombo
            ...
            DropDownCount = 15
            Ctl3D = False
            DataField = 'ID_CONTABIL_OPE_ORIG'
            DataSource = DMCadTransferencia.dsTransferencia
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
            ...
            LookupField = 'ID'
            LookupDisplay = 'NOME'
            LookupSource = DMCadTransferencia.dsContabil_Ope
            ParentCtl3D = False
            ParentFont = False
            TabOrder = 0
          end
          object RxDBLookupCombo12: TRxDBLookupCombo
            ...
            DropDownCount = 15
            Ctl3D = False
            DataField = 'ID_CONTABIL_OPE_DEST'
            DataSource = DMCadTransferencia.dsTransferencia
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -11

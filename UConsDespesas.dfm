object frmConsDespesas: TfrmConsDespesas
  Left = 249
  Top = 79
  ...
  object Panel1: TPanel
    ...
    object RxDBLookupCombo2: TRxDBLookupCombo
      ...
      LookupField = 'CODIGO'
      LookupDisplay = 'NOME'
      LookupSource = DMConsFinanceiro.dsFornecedor
      ParentCtl3D = False
      TabOrder = 1
    end
    ...
    object ckOC: TCheckBox
      Left = 112
      Top = 93
      Width = 145
      Height = 17
      Caption = 'Mostrar OC Pendentes'
      Checked = True
      State = cbChecked
      TabOrder = 5
    end
  ...
  object SMDBGrid1: TSMDBGrid
    ...
    Align = alClient
    Ctl3D = False
    DataSource = DMConsFinanceiro.dsmDespesa

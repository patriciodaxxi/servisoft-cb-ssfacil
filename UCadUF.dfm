      ...
      object SMDBGrid1: TSMDBGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'PERC_ICMS'
            Title.Caption = '% ICMS Interestadual'
            Width = 81
            Visible = True
          end
          item
          ...
          item
            ...
            Title.Caption = '% ICMS Fundo Comb. a Pobreza'
            Width = 79
            Visible = True
          end
          item
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Exige Cod. Benef. Fiscal'
            Width = 70
            Visible = True
          end
          item
    ...
    object TS_Cadastro: TRzTabSheet
      ...
      object pnlCadastro: TPanel
        ...
        object Label7: TLabel
          ...
          Height = 13
          Alignment = taRightJustify
          Caption = '% ICMS Fundo  de Combate a Pobreza (Padr'#227'o):'
        end
        ...
        object DBCheckBox1: TDBCheckBox
          ...
          Width = 257
          Height = 17
          Caption = 'Exige o campo C'#243'digo do Benef'#237'cio Fiscal'
          DataField = 'EXIGE_CBENEF'
          DataSource = DMCadUF.dsUF
          TabOrder = 7
          ValueChecked = 'S'
          ValueUnchecked = 'N'
        ...
        object DBCheckBox2: TDBCheckBox
          ...
          Width = 353
          Height = 17
          Caption = 'Aceita Informar Contribuinte Isento no cadastro de Cliente'
          DataField = 'ACEITA_ISENTO'
          DataSource = DMCadUF.dsUF
          TabOrder = 8
          ValueChecked = 'S'
          ValueUnchecked = 'N'

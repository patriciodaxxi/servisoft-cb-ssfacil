...
type
  TDMConsMapaCompras = class(TDataModule)
    ...
    sdsMapaCompras: TSQLDataSet;
    dspMapaCompras: TDataSetProvider;
    cdsMapaCompras: TClientDataSet;
    dsMapaCompras: TDataSource;
    frxMapaCompras: TfrxDBDataset;
    ...
    cdsMapaComprasID_PRODUTO: TIntegerField;
    cdsMapaComprasNOME_PRODUTO: TStringField;
    cdsMapaComprasQTD_ESTOQUE_MIN: TFloatField;
    cdsMapaComprasREFERENCIA: TStringField;
    cdsMapaComprasID_MARCA: TIntegerField;
    cdsMapaComprasNOME_MARCA: TStringField;
    cdsMapaComprasQTD_ESTOQUE: TFMTBCDField;
    cdsMapaComprasQTD_COMPRA: TFloatField;
    cdsMapaComprasRESULTADO: TFloatField;
    cdsMapaComprasQTD_APRODUZIR: TFloatField;
    cdsMapaComprasQTD_SALDO: TFloatField;
    cdsMapaComprasQTD_PEDIDO: TFloatField;
...
var
  DMConsMapaCompras: TDMConsMapaCompras;
...
procedure TDMConsMapaCompras.DataModuleCreate(Sender: TObject);
begin
  ...
  ctMapa_Compras     := sdsMapaCompras.CommandText;
...
procedure TDMConsMapaCompras.dspEstoqueUpdateError(Sender: TObject;
...
procedure TDMConsMapaCompras.cdsEstoqueCalcFields(DataSet: TDataSet);
begin
...
procedure TDMConsMapaCompras.prc_Abrir_Produto(Inativo: String);
begin
  cdsProduto.Close;
...
procedure TDMConsMapaCompras.cdsEstoque_CliCalcFields(DataSet: TDataSet);
begin
...
procedure TDMConsMapaCompras.cdsBalancoCalcFields(DataSet: TDataSet);
begin
...
function TDMConsMapaCompras.fnc_Saldo_Ant(ID_Produto, Filial : Integer ; Tamanho : String ;
...
procedure TDMConsMapaCompras.prc_Abrir_Veiculo(Inativo: String);
begin
  cdsVeiculo.Close;
...
procedure TDMConsMapaCompras.cdsBalanco_VeiCalcFields(DataSet: TDataSet);
begin
...
procedure TDMConsMapaCompras.prc_Posiciona_Pesssoa(Codigo: Integer);
begin
  qPessoa.Close;
...
procedure TDMConsMapaCompras.prc_Posiciona_Produto(ID : Integer ; Referencia : String);
begin
  qProduto.Close;

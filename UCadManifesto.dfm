object frmCadManifesto: TfrmCadManifesto
  Left = 181
  Top = 129
  Width = 962
  Height = 517
  BorderIcons = [biSystemMenu, biMaximize]
  Caption = 'Manifesto Carga/Romaneio Endere'#231'o'
  Color = clBtnFace
  ...
  object RzPageControl1: TRzPageControl
    ...
    object TS_Consulta: TRzTabSheet
      ...
      object SMDBGrid1: TSMDBGrid
        ...
        Align = alClient
        Ctl3D = False
        DataSource = DMCadManifesto.dsConsulta
    ...
    object TS_Cadastro: TRzTabSheet
      ...
      object pnlCadastro: TPanel
        ...
        object DBEdit7: TDBEdit
          ...
          Ctl3D = False
          DataField = 'DESCRICAO'
          DataSource = DMCadManifesto.dsManifesto
          ParentCtl3D = False
          TabOrder = 3
        end
      ...
      object RzPageControl2: TRzPageControl
        ...
        Height = 296
        ActivePage = TS_Cob
        ActivePageDefault = TS_Notas
        Align = alClient
        TabIndex = 1
        TabOrder = 2
        FixedDimension = 19
        object TS_Notas: TRzTabSheet
          Caption = 'Notas'
          ...
          object SMDBGrid2: TSMDBGrid
            ...
            Align = alClient
            Ctl3D = False
            DataSource = DMCadManifesto.dsManifesto_Nota
            Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit]
            ParentCtl3D = False
            ReadOnly = True
            TabOrder = 1
        ...
        object TS_Cob: TRzTabSheet
          ...
          object Panel3: TPanel
            ...
            Enabled = False
            TabOrder = 0
            object btnInserir_Cob: TNxButton
              Left = 1
              Top = 4
              Width = 75
              Caption = 'Inserir'
              ...
              ParentFont = False
              TabOrder = 0
              OnClick = btnInserir_CobClick
            end
            object btnAlterar_Cob: TNxButton
              Left = 76
              Top = 4
              Width = 75
              Caption = 'Alterar'
              ...
              ParentFont = False
              TabOrder = 1
              OnClick = btnAlterar_CobClick
            end
            object btnExcluir_Cob: TNxButton
              Left = 151
              Top = 4
              Width = 75
              Caption = 'Excluir'
  ...
  object PopupMenu1: TPopupMenu
    Left = 417
    Top = 23
    object ManifestodeCarga1: TMenuItem
      Caption = 'Manifesto de Carga'
      OnClick = ManifestodeCarga1Click
    end
    object RomaneiodeEndereo1: TMenuItem
      Caption = 'Romaneio de Endere'#231'o'
      OnClick = RomaneiodeEndereo1Click
    end
    object RomaneioFechamento1: TMenuItem
      Caption = 'Romaneio Fechamento'
      OnClick = RomaneioFechamento1Click
    end
    object Roteiro1: TMenuItem
      Caption = 'Roteiro'
      OnClick = Roteiro1Click
    end
  end
end

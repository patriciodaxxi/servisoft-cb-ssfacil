object frmCadMetas_Vendedor: TfrmCadMetas_Vendedor
  Left = 312
  Top = 168
  Width = 763
  Height = 462
  BorderIcons = [biSystemMenu, biMaximize]
  Caption = 'Cadastro de Metas de Vendas'
  Color = clBtnFace
  ...
  object RzPageControl1: TRzPageControl
    ...
    object TS_Consulta: TRzTabSheet
      ...
      object SMDBGrid1: TSMDBGrid
        ...
        Align = alClient
        Ctl3D = False
        DataSource = DMCadMetas_Vendedor.dsConsulta
    ...
    object TS_Cadastro: TRzTabSheet
      ...
      object pnlCadastro: TPanel
        ...
        object DBEdit2: TDBEdit
          ...
          DataField = 'ANO'
          DataSource = DMCadMetas_Vendedor.dsMetas_Vendedor
          TabOrder = 3
          OnExit = DBEdit2Exit
        end
        ...
        object RxDBLookupCombo1: TRxDBLookupCombo
          ...
          LookupField = 'CODIGO'
          LookupDisplay = 'NOME'
          LookupSource = DMCadMetas_Vendedor.dsVendedor
          TabOrder = 1
        end
        object ComboBox1: TComboBox
          ...
          ItemIndex = 0
          TabOrder = 0
          Text = '[Especificar Por Vendedor]'
          Visible = False
          OnClick = ComboBox1Click
          Items.Strings = (
            '[Especificar Por Vendedor]'
            'Sul'
            'Sudeste'
            'Centro-Oeste'
            'Nordeste'

...
procedure TfRelTalao_Rot.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := Cafree;
end;

procedure TfRelTalao_Rot.RLReport1BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  oDBUtils.SetDataSourceProperties(Self, fDMCadLote);
end;

procedure TfRelTalao_Rot.RLBand1BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
var
  vTexto: String;
  vTexto_OS: String;

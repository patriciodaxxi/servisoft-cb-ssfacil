...
var
  fRelTalao_Rot_A4: TfRelTalao_Rot_A4;
...
procedure TfRelTalao_Rot_A4.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := Cafree;
end;

procedure TfRelTalao_Rot_A4.RLReport1BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  oDBUtils.SetDataSourceProperties(Self, fDMCadLote);
end;

procedure TfRelTalao_Rot_A4.RLDetailGrid1BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
var
  vTexto : String;
  vTexto_OS : String;

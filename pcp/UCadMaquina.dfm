  ...
  object RzPageControl1: TRzPageControl
    ...
    object TS_Consulta: TRzTabSheet
      ...
      object SMDBGrid1: TSMDBGrid
        ...
        Align = alClient
        Ctl3D = False
        DataSource = DMCadMaquina.dsConsulta
        ...
        Columns = <
          ...
          item
            ...
            FieldName = 'NOME_TIPO'
            Title.Alignment = taCenter
            Title.Caption = 'Tipo M'#225'quina'
            Visible = True
          end
          item
            Alignment = taCenter
    ...
    object TS_Cadastro: TRzTabSheet
      ...
      object pnlCadastro: TPanel
        ...
        object RxDBLookupCombo1: TRxDBLookupCombo
          ...
          Height = 21
          DropDownCount = 8
          DataField = 'ID_TIPO_MAQUINA'
          DataSource = DMCadMaquina.dsMaquina
          LookupField = 'ID'
          LookupDisplay = 'NOME'
          LookupSource = DMCadMaquina.dsTipo_Maquina
          TabOrder = 2
          OnChange = RxDBLookupCombo1Change
        end
        object gbxTear: TRzGroupBox
          Left = 92
          Top = 135
          Width = 205
          Height = 82
          ...
          object DBEdit5: TDBEdit
            ...
            Height = 21
            CharCase = ecUpperCase
            DataField = 'QTD_QUADRO'
            DataSource = DMCadMaquina.dsMaquina
            TabOrder = 2
          end
        end
        object gbxTrancadeira: TRzGroupBox
          Left = 300
          Top = 135
          Width = 205
          Height = 82
        ...
        object DBCheckBox1: TDBCheckBox
          ...
          Width = 161
          Height = 17
          Caption = ' Alimentador de Borracha'
          DataField = 'BORRACHA'
          DataSource = DMCadMaquina.dsMaquina
          TabOrder = 4
          ValueChecked = 'S'
        ...
        object DBCheckBox2: TDBCheckBox
          ...
          Width = 161
          Height = 17
          Caption = 'Fio Auxiliar'
          DataField = 'FIO_AUXILIAR'
          DataSource = DMCadMaquina.dsMaquina
          TabOrder = 5
          ValueChecked = 'S'
          ValueUnchecked = 'N'
      ...
      object pnlConsumo: TPanel
        ...
        Color = clSilver
        TabOrder = 2
        object btnInserir_Tipo: TNxButton
          Left = 5
          Top = 1
          Width = 146
          Height = 30
          Hint = 'Inserir Tipo da matriz'
          Caption = 'Inserir Tipo'
          Enabled = False
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -13
          ...
          TabOrder = 0
          Transparent = True
          OnClick = btnInserir_TipoClick
        end
        object btnAlterar_Tipo: TNxButton
          Left = 150
          Top = 1
          Width = 147
          Height = 30
          Hint = 'Alterar o tipo de matriz'
          ...
          TabOrder = 1
          Transparent = True
          OnClick = btnAlterar_TipoClick
        end
        object btnExcluir_Tipo: TNxButton
          Left = 296
          Top = 1
          Width = 147
          Height = 30
          Hint = 'Excluir o tipo da matriz'
      ...
      object SMDBGrid3: TSMDBGrid
        ...
        Height = 187
        Align = alBottom
        DataSource = DMCadMaquina.dsMaquina_Matriz
        Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit]
        ReadOnly = True
        TabOrder = 3
        TitleFont.Charset = DEFAULT_CHARSET

object frmCadProduto_GradeNum: TfrmCadProduto_GradeNum
  Left = 207
  Top = 66
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'frmCadProduto_GradeNum'
  ClientHeight = 585
  ClientWidth = 630
  Color = clBtnFace
  ...
  object pnlDados: TPanel
    ...
    object RxDBLookupCombo1: TRxDBLookupCombo
      ...
      Ctl3D = False
      DataField = 'TAMANHO'
      DataSource = dmCadProduto.dsProduto_GradeNum
      LookupField = 'TAMANHO'
      LookupDisplay = 'TAMANHO'
      LookupSource = dmCadProduto.dsTamanho
      ParentCtl3D = False
      TabOrder = 0
    end

object frmCadNatureza: TfrmCadNatureza
  Left = 264
  Top = 135
  Width = 803
  Height = 543
  BorderIcons = [biSystemMenu, biMaximize]
  Caption = 'Cadastro da Natureza da Nota de Servi'#231'o'
  Color = clBtnFace
  ...
  object RzPageControl1: TRzPageControl
    ...
    object TS_Consulta: TRzTabSheet
      ...
      object SMDBGrid1: TSMDBGrid
        ...
        Align = alClient
        Ctl3D = True
        DataSource = DMCadNatureza.dsNatureza
        ...
        Columns = <
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'C'#243'd. Natureza'
            Width = 63
            Visible = True
          end
          item
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Tributa'#231#227'o do Munic'#237'pio (Dentro / Fora)'
            Width = 72
            Visible = True
          end
          item
    ...
    object TS_Cadastro: TRzTabSheet
      ...
      object pnlCadastro: TPanel
        ...
        object RxDBComboBox1: TRxDBComboBox
          ...
          DataField = 'TRIBUTACAO_DF'
          DataSource = DMCadNatureza.dsNatureza
          EnableValues = True
          ItemHeight = 13
          Items.Strings = (
            'Dentro do Munic'#237'pio'
            'Fora do Munic'#237'pio'
            'Nenhum')
          TabOrder = 4
          Values.Strings = (
            'D'
        ...
        object RxDBLookupCombo1: TRxDBLookupCombo
          ...
          Height = 21
          DropDownCount = 8
          DataField = 'ID_PROVEDOR'
          DataSource = DMCadNatureza.dsNatureza
          LookupField = 'ID'
          LookupDisplay = 'NOME'
          LookupSource = DMCadNatureza.dsProvedor
          TabOrder = 3
        end
        ...
        object DBCheckBox1: TDBCheckBox
          ...
          Width = 97
          Height = 17
          Caption = 'Ret'#233'm ISSQN'
          DataField = 'RETER_ISSQN'
          DataSource = DMCadNatureza.dsNatureza
          TabOrder = 7
          ValueChecked = 'S'
          ValueUnchecked = 'N'
        ...
        object DBCheckBox2: TDBCheckBox
          ...
          Width = 193
          Height = 17
          Caption = 'Usar o Munic'#237'pio do Cliente'
          DataField = 'USA_CIDADE_CLI'
          DataSource = DMCadNatureza.dsNatureza
          TabOrder = 8
          ValueChecked = 'S'
          ValueUnchecked = 'N'

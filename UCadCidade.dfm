    ...
    object TS_Cadastro: TRzTabSheet
      ...
      object pnlCadastro: TPanel
        ...
        object RxDBLookupCombo2: TRxDBLookupCombo
          ...
          LookupField = 'ID'
          LookupDisplay = 'NOME'
          LookupSource = DMCadCidade.dsProvedor
          TabOrder = 4
        end
        ...
        object DBCheckBox1: TDBCheckBox
          ...
          Height = 17
          Caption = 
            'Cancelamento das Notas de Servi'#231'o (NFSe) somente pelo site da Pr' +
            'efeitura'
          DataField = 'CANCELAMENTO_NFSE'
          DataSource = DMCadCidade.dsCidade
          TabOrder = 9
          ValueChecked = 'P'
          ValueUnchecked = 'N'

object frmCadProvedor: TfrmCadProvedor
  Left = 183
  Top = 24
  Width = 981
  Height = 647
  Caption = 'Cadastro de Provedores (NFSe)'
  Color = clBtnFace
      ...
      object SMDBGrid1: TSMDBGrid
        ...
        Columns = <
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Natureza (Geral / Pr'#243'pria)'
            Width = 143
            Visible = True
          end
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Tipo Retorno (Protocolo / Lote)'
            Visible = True
          end>
      end
    ...
    object TS_Cadastro: TRzTabSheet
      ...
      object pnlCadastro: TPanel
        ...
        object Label4: TLabel
          ...
          Height = 52
          Caption = 
            'Tipo Retorno: Vai servir para identificar o tipo de retorno que ' +
            'o '#13#10'WS do provedor  vai retornar para identificar se deu ok ou n' +
            #227'o o '#13#10'envio do lote. '#201' atrav'#233's deste tipo de retorno que vai se' +
            'r feita a '#13#10'consulta do lote, que vai trazer a numera'#231#227'o das not' +
            'as para cada RPS'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clGreen
          Font.Height = -11
        ...
        object Label47: TLabel
          ...
          Height = 13
          Alignment = taRightJustify
          Caption = 'Informar a Al'#237'quota no XML:'
        end
        object Label48: TLabel
          ...
          Height = 13
          Alignment = taRightJustify
          Caption = 'Informar C'#243'd. Servi'#231'o no XML::'
        end
        object Label5: TLabel
          ...
          Height = 13
          Alignment = taRightJustify
          Caption = 'ISSQN Com Reten'#231#227'o Gravar:'
        end
        object Label7: TLabel
          ...
          Height = 39
          Caption = 
            'ISSQN Com Reten'#231#227'o Gravar: '#13#10' Em S'#227'o Leopoldo (THEMA) marcar com' +
            'o "No Vlr. de Reten'#231#227'o e Vlr. ISSQN"'#13#10' em Novo Hamburgo (ISS.NET' +
            ') marcar como "Somente no Vlr. de Reten'#231#227'o"'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clGreen
          Font.Height = -11
          Font.Name = 'MS Sans Serif'
        ...
        object Label9: TLabel
          ...
          Height = 13
          Alignment = taRightJustify
          Caption = 'Atividade do Municipio possui o C'#243'd. Servi'#231'o:'
        end
        object Label10: TLabel
          ...
          Height = 39
          Caption = 
            'Atividade do Municipio possui o C'#243'd. Servi'#231'o:'#13#10'   Porto Alegre: ' +
            'Marcar como SIM'#13#10'   Outras cidades: Marcar com N'#195'O'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clGreen
          Font.Height = -11
          Font.Name = 'MS Sans Serif'
        ...
        object RxDBComboBox4: TRxDBComboBox
          ...
          Height = 21
          Style = csDropDownList
          DataField = 'RETENCAO_ISSQN'
          DataSource = DMCadProvedor.dsProvedor
          EnableValues = True
          ItemHeight = 13
          Items.Strings = (
            'No Vlr. de Reten'#231#227'o e Vlr. ISSQN'
            'Somente no Vlr. de Reten'#231#227'o')
          TabOrder = 7
          Values.Strings = (
            'S'
            'N')
        ...
        object RxDBComboBox5: TRxDBComboBox
          ...
          Height = 21
          Style = csDropDownList
          DataField = 'USA_ATIVIDADE_CID_SERV'
          DataSource = DMCadProvedor.dsProvedor
          EnableValues = True
          ItemHeight = 13
          Items.Strings = (

object frmCadRegra_Empresa_Itens: TfrmCadRegra_Empresa_Itens
  Left = 398
  Top = 312
  ...
  object DBRadioGroup1: TDBRadioGroup
    ...
    Width = 193
    Height = 57
    Caption = ' Pessoa Destinat'#225'rio '
    DataField = 'PESSOA_CLIENTE'
    DataSource = DMCadRegra_Empresa.dsRegra_Empresa_Itens
    Items.Strings = (
      'Jur'#237'dica Contribuinte'
      'Jur'#237'dica N'#227'o Contribuinte/F'#237'sica')
    TabOrder = 0
    Values.Strings = (
      'J'
      'F')
  ...
  object qItens: TSQLQuery
    ...
    SQL.Strings = (
        ...
        ','
      'i.zona_franca, i.subst_tributaria'

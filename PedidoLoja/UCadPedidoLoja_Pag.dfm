object frmCadPedidoLoja_Pag: TfrmCadPedidoLoja_Pag
  Left = 426
  Top = 160
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'frmCadPedidoLoja_Pag'
  ClientHeight = 403
  ClientWidth = 639
  Color = 16767927
  ...
  object SMDBGrid_Dupl2: TSMDBGrid
    ...
    ExOptions = [eoDisableDelete, eoENTERlikeTAB, eoKeepSelection, eoStandardPopup, eoBLOBEditor, eoTitleWordWrap]

object frmCadUnidade_Conv: TfrmCadUnidade_Conv
  Left = 453
  Top = 213
  Width = 594
  Height = 189
  Caption = 'Cadastro Unidade da Convers'#227'o'
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object RxDBLookupCombo3: TRxDBLookupCombo
      ...
      DropDownCount = 8
      DropDownWidth = 200
      DataField = 'UNIDADE_CONV'
      DataSource = DMCadUnidade.dsUnidade_Conv
      LookupField = 'UNIDADE'
      LookupDisplay = 'UNIDADE;NOME'
      LookupSource = DMCadUnidade.dsUnidade2
      TabOrder = 0
    end
    ...
    object RxDBComboBox1: TRxDBComboBox
      ...
      Items.Strings = (
        'L=Peso Liquido'
        'B=Peso Bruto'
        'C=Informar a quantidade de conversao')
      TabOrder = 1
      Values.Strings = (
        'L'
        'B'

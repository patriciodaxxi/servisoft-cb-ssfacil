object frmCadSetor: TfrmCadSetor
  Left = 227
  Top = 85
  Width = 857
  Height = 570
      ...
      object SMDBGrid1: TSMDBGrid
        ...
        Columns = <
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Limite por Tal'#227'o'
            Visible = True
          end
          item
            Alignment = taCenter
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Qd. Limite por Tal'#227'o'
            Width = 72
            Visible = True
          end
          item
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Entrada Autom'#225'tica'
            Width = 72
            Visible = True
          end>
      end
      ...
      object pnlCadastro: TPanel
        ...
        object RzGroupBox1: TRzGroupBox
          ...
          object DBCheckBox2: TDBCheckBox
            ...
            Width = 185
            Height = 17
            Caption = 'Gerar Tal'#227'o Separado'

...
procedure NFeIntegracaoContab(AServidor, ACnpj, ACNPJConsulta, AMod: string; AindXML, AindEmit, AindDest, AultNSU: Integer; AXml: TStream);
...
begin
  ...
  try
    try
      ...
      TCPClient.WriteInteger(AultNSU);
